...
public class FileBasedExercises {
	...
	public void setUpBufferedReader() throws IOException, URISyntaxException {
		reader = Files.newBufferedReader(
				Paths.get(getClass().getResource("/SonnetI.txt").toURI()),
	...
	public void sortedLowerCase() throws IOException {
		List<String> output = reader.lines()
				.flatMap(l -> Stream.of(l.split(REGEXP)))
				.filter(w -> w.length() > 0).map(String::toLowerCase).sorted()
	...
	public void sortedLowerCaseDistinctByLengthThenAlphabetically()
		...
		List<String> output = reader
				...
				.distinct()
				.sorted(Comparator.comparingInt(String::length).thenComparing(
